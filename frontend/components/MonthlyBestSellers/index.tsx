...
// Interfaz para cada producto bestseller mensual
interface MonthlyBestSellerProduct {
    año_mes: number;
...
interface MonthlyBestSellersProps {
    data: MonthlyBestSellerProduct[];
    loading: boolean;
}

const MonthlyBestSellers = ({ data, loading }: MonthlyBestSellersProps) => {
    ...
    const renderProductItem = (product: MonthlyBestSellerProduct, index: number) => {
    ...
    return (
        <View style={styles.bestSellers}>
            ...
            <View style={styles.header}>
                ...
                <MaterialCommunityIcons name="star-outline" size={24} color="#EAB308" />
            </View>
...
export default MonthlyBestSellers;